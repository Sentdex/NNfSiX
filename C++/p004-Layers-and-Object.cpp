...
vector<vector<double>> dotProduct(const vector<vector<double>>& inputs, const vector<vector<double>>& weights) {
...
vector<double> add(const vector<double>& vector1, const vector<double>& vector2) {
